	...
	rundateoforder: async () => {
		...
		for (const value of customerLineItems) {
			...
			const orderInfo = {
				...
				PrinterCurrency: printerItem[0].Printer !== null && printerItem[0].Printer !== 'CANCELLED' ? printerCurrency.find(printer => printer.PrinterName === printerItem[0].Printer).Currency : 'N/A',
